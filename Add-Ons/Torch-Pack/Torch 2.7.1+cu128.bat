@echo off&&cd /d %~dp0
Title Torch 2.7.1 for 'ComfyUI Easy Install' by ivo
...
echo %green%::::::::::::::: Updating%yellow% Torch 2.7.1 %green%:::::::::::::::%reset%
echo.

..\..\python_embeded\python.exe -I -m pip uninstall torch torchvision torchaudio -y
..\..\python_embeded\python.exe -I -m pip install torch==2.7.1 torchvision==0.22.1 torchaudio==2.7.1 --index-url https://download.pytorch.org/whl/cu128 %PIPargs%
